...
OTU.ts.long |> filter(OTU %in% names(df.2)) |>
...
OTU.ts.long |> filter(OTU %in% names(df.3)) |>
...
Loading objects
```{r}
ul.dna.soilotus.always <- read_excel("/Users/tj/Library/CloudStorage/OneDrive-MississippiStateUniversity/Research/Microbial ecology/sortedotus.xlsx", sheet = "ul.dna.soilotus.always")

ul.dna.soilotus.blips <- read_excel("/Users/tj/Library/CloudStorage/OneDrive-MississippiStateUniversity/Research/Microbial ecology/sortedotus.xlsx", sheet = "ul.dna.soilotus.blips")

ul.dna.soilotus.fh <- read_excel("/Users/tj/Library/CloudStorage/OneDrive-MississippiStateUniversity/Research/Microbial ecology/sortedotus.xlsx", sheet = "ul.dna.soilotus.fh")

ul.dna.soilotus.s1 <- read_excel("/Users/tj/Library/CloudStorage/OneDrive-MississippiStateUniversity/Research/Microbial ecology/sortedotus.xlsx", sheet = "ul.dna.soilotus.s1")

ul.dna.soilotus.s2 <- read_excel("/Users/tj/Library/CloudStorage/OneDrive-MississippiStateUniversity/Research/Microbial ecology/sortedotus.xlsx", sheet = "ul.dna.soilotus.s2")

ul.dna.soilotus.s3 <- read_excel("/Users/tj/Library/CloudStorage/OneDrive-MississippiStateUniversity/Research/Microbial ecology/sortedotus.xlsx", sheet = "ul.dna.soilotus.s3")
