...
OTUs Filtered by abundance in soil
...
Looking into seedbank dynamics
...
```{r}
df.1c<- Q3 |> select(any_of(clsfd.ac.1$OTU))
...
# Obtain the clusters for the current iteration
clusters.1c <- cutree(hclust_result.1c, k = 5)
